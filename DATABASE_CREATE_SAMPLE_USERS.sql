-- Create Sample Users for TASUED Connect Application
-- This script creates an admin, a lecturer, and a student user

-- 1. CREATE ADMIN USER
-- First, create the auth user (this would normally be done through the auth system)
-- For demonstration, we'll insert directly into the users table

-- Note: In production, these would be created through the registration process
-- This script is for seeding/initial setup purposes
...
INSERT INTO public.users (id, email, first_name, last_name, role, staff_id, department, title, is_active, is_email_verified)
VALUES (
  '44444444-4444-4444-4444-444444444444',  -- Sample UUID
...
INSERT INTO public.users (id, email, first_name, last_name, role, matric_number, level, is_active, is_email_verified)
VALUES (
  '55555555-5555-5555-5555-555555555555',  -- Sample UUID
...
INSERT INTO public.users (id, email, first_name, last_name, role, matric_number, level, is_active, is_email_verified)
VALUES (
  '66666666-6666-6666-6666-666666666666',  -- Sample UUID
...
SELECT 
  (SELECT id FROM courses WHERE code = 'CSC201'),
  '55555555-5555-5555-5555-555555555555',  -- Bob Williams' ID
  'active'
ON CONFLICT (course_id, student_id) DO NOTHING;
...
SELECT 
  (SELECT id FROM courses WHERE code = 'CSC201'),
  '66666666-6666-6666-6666-666666666666',  -- Alice Brown's ID
  'active'
ON CONFLICT (course_id, student_id) DO NOTHING;

-- 8. CREATE A SAMPLE LECTURE SESSION
INSERT INTO lecture_session (id, course_id, lecturer_id, session_date, start_time, end_time, location, session_code, status)
VALUES (
  gen_random_uuid(),
  (SELECT id FROM courses WHERE code = 'CSC201'),
  '22222222-2222-2222-2222-222222222222',  -- John Doe's ID
